    ...
    return (
        <div className="w-full max-w-4xl mx-auto py-8">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-6">
                <Link className="hover:text-primary transition-colors" to="/user/dashboard">Dashboard</Link>
            ...
            <div className="glass-panel rounded-3xl overflow-hidden relative border border-gray-200 dark:border-white/10 shadow-xl bg-card-light dark:bg-card-dark">
                {/* Cover Photo */}
                <div className="h-32 bg-gradient-to-r from-emerald-800 to-primary/30 relative">
                ...
                <div className="px-8 pb-8">
                    <div className="relative flex flex-col sm:flex-row items-end sm:items-center -mt-12 mb-8 gap-6">
                        ...
                        <div className="flex-1 text-center sm:text-left pt-2 sm:pt-12">
                            <h2 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center justify-center sm:justify-start gap-2">
                                {name}
                                <span className="material-symbols-outlined text-primary text-xl" title="Verified User">verified</span>
                            </h2>
                    ...
                    <form className="space-y-8" onSubmit={handleSave}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            className="w-full bg-input-bg-light dark:bg-input-bg-dark border border-gray-200 dark:border-white/10 pl-10 pr-4 py-2.5 rounded-xl text-sm transition-all text-typography-light dark:text-white focus:ring-2 focus:ring-primary focus:outline-none placeholder-gray-400 dark:placeholder-gray-500"
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                                <span className="p-1.5 rounded-lg bg-[#84cc16]/10 text-[#84cc16]">
                                    <span className="material-symbols-outlined text-xl">verified_user</span>
                                </span>
                                Identity Verification
                            </h3>
                            <div className="relative group">
                                <div className="absolute -inset-0.5 bg-gradient-to-r from-primary to-[#84cc16] rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-500"></div>
                                <div className="relative w-full border-2 border-dashed border-[#84cc16]/50 dark:border-[#84cc16]/30 bg-gray-50/50 dark:bg-black/20 rounded-2xl p-8 text-center hover:bg-[#84cc16]/5 transition-colors cursor-pointer group-hover:border-[#84cc16]">
                                    <div className="flex flex-col items-center justify-center gap-3">
                                        <div className="w-16 h-16 rounded-full bg-[#84cc16]/10 flex items-center justify-center mb-2">
                                            <span className="material-symbols-outlined text-3xl text-[#84cc16]">cloud_upload</span>
                                        </div>
                                        <h4 className="text-base font-semibold text-gray-900 dark:text-white">Upload your NID (Front &amp; Back)</h4>
                                        <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm mx-auto">
                                            Drag and drop your files here, or <span className="text-[#84cc16] hover:underline font-medium">browse files</span>. Supported formats: JPEG, PNG, PDF.
                                        </p>
                                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <select className="w-full bg-input-bg-light dark:bg-input-bg-dark border border-gray-200 dark:border-white/10 pl-10 pr-10 py-2.5 rounded-xl text-sm appearance-none cursor-pointer focus:ring-2 focus:ring-primary focus:outline-none text-gray-800 dark:text-gray-100" defaultValue="advanced">
                        ...
                        <div className="pt-6 flex flex-col sm:flex-row items-center justify-end gap-4">
                            ...
                            <button className="w-full sm:w-auto bg-gradient-to-r from-primary to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 text-white px-8 py-2.5 rounded-xl text-sm font-semibold shadow-lg shadow-emerald-500/30 transition-all transform hover:scale-[1.02] active:scale-[0.98]" type="submit">
                                Save Profile
                            </button>
                        </div>
                    </form>
