...
<div className="glass-panel bg-white/40 dark:bg-glass-bg border border-slate-200 dark:border-glass-border p-6 rounded-2xl">
...
<div className="glass-panel bg-white/60 dark:bg-glass-bg border border-slate-200 dark:border-glass-border rounded-3xl p-6 shadow-glass relative">
...
<div className="glass-panel bg-white/70 dark:bg-glass-bg border border-slate-200 dark:border-glass-border rounded-3xl p-8 hover:transform hover:-translate-y-2 transition-transform duration-300 flex flex-col relative overflow-hidden">
<div className="mb-6">
